...
import 'package:flutter_application_1/widget/EcommerceWidget.dart';
        ...
        children: [
            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: const Color.fromARGB(255, 126, 186, 83),
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: Column(
                              ...
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Text('introducing',style:TextStyle(fontWeight: FontWeight.bold,fontSize: 20.0)),
                                 Text('Air Max 2090',style:TextStyle(fontWeight: FontWeight.bold,fontSize: 20.0)),
                                 Container(
                                   height: 40,
                                   width: 100,
         ...
         Wrap(
          ...
          children:List.generate(5, (index) =>
            Ecommercewidget(name: "kd", icon: Icons.ac_unit_rounded))
          )
